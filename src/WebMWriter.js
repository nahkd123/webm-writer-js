...
(function() {
    ...
    const 
        EBML_SIZE_UNKNOWN = -1,
        EBML_SIZE_PLACEHOLDER_5_BYTES = -2;
    ...
    function writeEBML(buffer, bufferFileOffset, ebml) {
        ...
        if (Array.isArray(ebml)) {
            ...
            if (Array.isArray(ebml.data)) {
                ...
                } else if (ebml.size === EBML_SIZE_PLACEHOLDER_5_BYTES) {
                    sizePos = buffer.pos;
        ...
        return function(options) {
            ...
            function writeHeader() {
                ...
                ebmlSegment = {
                    ...
                    "size": EBML_SIZE_PLACEHOLDER_5_BYTES, // We'll seek back and fill this in at completion
                    "data": [
                        seekHead,
                        segmentInfo,
                        tracks,
